...
#define LCD_StatusRead() *(volatile uint16_t *)(LCD_BASE0)
#define LCD_DataRead() *(volatile uint16_t *)(LCD_BASE1)
...
void lcdFillRect(
    int16_t x, int16_t y, int16_t w, int16_t h, uint16_t fillcolor);
void lcdFillRoundRect(
    int16_t x, int16_t y, int16_t w, int16_t h, int16_t r, uint16_t color);
void lcdFillTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2,
    int16_t y2, uint16_t color);
void lcdDrawImage(
    uint16_t x, uint16_t y, GUI_CONST_STORAGE GUI_BITMAP *pBitmap);
void lcdHome(void);
void lcdDrawChar(
